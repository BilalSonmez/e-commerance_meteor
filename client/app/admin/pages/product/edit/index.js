...
Template.adminPagesProductEdit.onCreated(function() {
...
Template.adminPagesProductEdit.onRendered(function() {
    const self = this;
...
Template.adminPagesProductEdit.events({
    ...
    'submit #productEdit': function(event, template) { 
        event.preventDefault();
        let image_areas_doms = document.querySelectorAll("#productEdit .image-area-input");
        let image_area = [];
        ...
        Meteor.call('product.update', obj, function (error, result) {
